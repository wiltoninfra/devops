...
///
#define CPP_HOCON_VERSION_PATCH 2

///
/// The cpp-hocon library version as a string (without commit SHA1).
///
#define CPP_HOCON_VERSION "0.1.2"

///
/// The cpp-hocon library version as a string (with commit SHA1).
///
#define CPP_HOCON_VERSION_WITH_COMMIT "0.1.2 (commit 89d0e6937cdf488e0c3c18a5fc930cfacd39a7e7)"
