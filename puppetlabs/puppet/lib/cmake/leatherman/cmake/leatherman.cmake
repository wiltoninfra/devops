    ...
    if (MSGFMT_EXE)
        ...
        foreach(fpath ${TRANSLATIONS})
            ...
            if(LEATHERMAN_LOCALE_INSTALL)
                install(FILES ${mo} DESTINATION "/opt/puppetlabs/puppet/${LEATHERMAN_LOCALE_INSTALL}/${lang}/LC_MESSAGES")
            else()
                install(FILES ${mo} DESTINATION "/opt/puppetlabs/puppet/share/locale/${lang}/LC_MESSAGES")
            endif()
        endforeach()
